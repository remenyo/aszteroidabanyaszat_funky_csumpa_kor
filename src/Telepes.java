...
public class Telepes extends Szereplo {
	 ...
	 * 
	 * @return ArrayList<Nyersanyag> A telepesnél lévő nyersanyagok listája.
	 */
	@Override
	...
	/**
	 * Teszt alatt egyszer se hívódik meg de majd rendes működés alatt itt választhat a felhasználó,
	 ...
	 * majd meghívja a Szereplő meghal függvényét,ami kitörli az aszteroidáról és törli a
	 * léptethetők listájából. Végül meghívja a játékon a telepesmeghal függvényét.
	 */
	@Override
	public void Meghal() {
		Log.call();
