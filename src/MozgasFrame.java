...
public class MozgasFrame extends JDialog {
	private JComboBox<String> box = new JComboBox<String>(); // Aszteroidákat tartalmazza amire
																// lehet menni és ebből lehet
																// választani hova akarunk menni.
	...
	public MozgasFrame(ArrayList<Hely> szomszedok1) {
		...
		box.addItemListener(new ItemListener() {
			public void itemStateChanged(java.awt.event.ItemEvent evt) {
				...
				rajzPanel.setAszteroida(
						szomszedok.get(box.getSelectedIndex()).szomszedosAszteroida());
			}
		});
