...
public class Log {
    ...
    /**
     * Részletes log stringet építő függvény. Az átadott hívó objektum részletesen lesz kiírva.
     * 
     * @param level A sor elején olvasható címke pl. INFO vagy WARN
     * @param e A logot küldő objektum
    ...
    /**
     * Egyszerű log stringet építő függvény. Az átadott hívó objektum pár információja lesz csak
     * leírva.
     * 
     * @param level A sor elején olvasható címke pl. INFO vagy WARN
     * @param e A logot küldő objektum
     ...
     * 
     * @param message A loghoz tartozó üzenet (opcionális)
     * @param options első argumentum: 1 = részletes hívó leírás, 0 = egyszerű hívó leírás ; második
