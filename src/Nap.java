...
public class Nap implements Leptetheto {
	private ArrayList<Aszteroida> aszteroidak = new ArrayList<Aszteroida>(); // Nap körüli
																				// aszteroidák
	private ArrayList<Aszteroida> napviharravarok = new ArrayList<Aszteroida>(); // Akiken meg lesz
																					// hívva a
																					// napvihar
	private boolean napviharfolyamatban = false; // Azt jelzi, hogy az előrejelzés van-e

	/**
	 * Nap lépése, az aszteroidak 5% at kiválasztja és szól nekik madj, következő körben meghívja
	 * rajtuk.
	 */
	public void Lepes() {
		Log.call();
